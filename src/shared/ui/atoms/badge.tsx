...
export const badgeVariantClasses = {
  ...
  cyan:
    'border-transparent bg-cyan-500/15 text-cyan-700 dark:text-cyan-400 hover:bg-cyan-500/25',
  teal:
    'border-transparent bg-teal-500/15 text-teal-700 dark:text-teal-400 hover:bg-teal-500/25',
  orange:
    'border-transparent bg-orange-500/15 text-orange-700 dark:text-orange-400 hover:bg-orange-500/25',
  indigo:
    'border-transparent bg-indigo-500/15 text-indigo-700 dark:text-indigo-400 hover:bg-indigo-500/25',
  violet:
    'border-transparent bg-violet-500/15 text-violet-700 dark:text-violet-400 hover:bg-violet-500/25',
  pink:
    'border-transparent bg-pink-500/15 text-pink-700 dark:text-pink-400 hover:bg-pink-500/25',
} as const;

export const badgeVariantOptions = literalKeys(badgeVariantClasses);
...
const badgeVariants = cva(
  'inline-flex shrink-0 items-center whitespace-nowrap rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
