...
function getMonthDropdownLocale(locale: CalendarProps['locale']) {
  return locale?.code ?? 'ru-RU';
}
    ...
    <DayPicker
      ...
      formatters={{
        formatMonthDropdown: (date) =>
          date.toLocaleString(getMonthDropdownLocale(locale), { month: 'short' }),
        ...formatters,
      }}
      classNames={{
        root: cn('w-fit', defaultClassNames.root),
        months: cn(
          'relative flex flex-col gap-4 font-medium capitalize md:flex-row',
        ...
        day: cn(
          'group/day relative aspect-square h-full w-full select-none p-0 text-center font-medium [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md',
