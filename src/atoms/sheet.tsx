...
function SheetContent({
  ...
  ...props
}: Omit<React.ComponentProps<typeof SheetPrimitive.Content>, 'forceMount'> & {
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:!pointer-events-none fixed z-50 flex flex-col gap-4 shadow-lg overflow-y-auto transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
          side === 'right' &&
