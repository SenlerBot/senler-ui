...
function c({ className: c, label: l, tooltip: u, id: d, "aria-label": f, title: p, name: m, "data-ai-kind": h, "data-ai-label": g, ..._ }) {
	let v = r.useId(), y = d || v, b = t(g, typeof f == "string" ? f : void 0, typeof p == "string" ? p : void 0, void 0, m, l);
	return /* @__PURE__ */ o("div", {
		...
		children: [/* @__PURE__ */ o("div", {
			...
			children: [/* @__PURE__ */ a(s.Root, {
				id: y,
				"data-slot": "checkbox",
				"data-ai-kind": h ?? e.field,
				"data-ai-label": b,
				"aria-label": f,
				title: p,
				name: m,
				className: n("peer size-4 shrink-0 rounded border shadow-xs transition-all outline-none cursor-pointer", "data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground data-[state=checked]:border-primary", "data-[state=unchecked]:bg-muted data-[state=unchecked]:border-border", "hover:border-primary", "focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]", "disabled:cursor-not-allowed disabled:opacity-50", c),
				..._,
